...
type HelloWorldClient interface {
	Print(ctx context.Context, in *HelloWorldRequest, opts ...grpc.CallOption) (*HelloWorldResponse, error)
}
...
func (c *helloWorldClient) Print(ctx context.Context, in *HelloWorldRequest, opts ...grpc.CallOption) (*HelloWorldResponse, error) {
	out := new(HelloWorldResponse)
	err := c.cc.Invoke(ctx, "/helloworld.HelloWorld/Print", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HelloWorldServer interface {
	Print(context.Context, *HelloWorldRequest) (*HelloWorldResponse, error)
...
func (UnimplementedHelloWorldServer) Print(context.Context, *HelloWorldRequest) (*HelloWorldResponse, error) {
...
func _HelloWorld_Print_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloWorldRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HelloWorldServer).Print(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/helloworld.HelloWorld/Print",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloWorldServer).Print(ctx, req.(*HelloWorldRequest))
	}
...
var HelloWorld_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Print",
			Handler:    _HelloWorld_Print_Handler,
		},
	},
